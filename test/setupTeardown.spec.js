...
describe('4 - Quem sobreviveu?', () => {
  ...
  test('Sobreviventes após primeiro ataque e segundo ataque', () => {
  ...
  test('Sobreviventes após segundo ataque e terceiro ataque', () => {
    console.table(adventure.specialists);
    adventure.randomAttack();
  });
  ...
  test('Sobreviventes após terceiro ataque e quarto ataque', () => {
    console.table(adventure.specialists);
    adventure.randomAttack();
  });
  ...
  test('Sobreviventes após quarto ataque e quinto ataque', () => {
    console.table(adventure.specialists);
    adventure.randomAttack();
  });
