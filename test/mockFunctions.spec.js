const rFact = require('./factorial');
const mockFunctions = require('../src/mockFunctions');
/*
Criamos uma série de funções com eficiência duvidosa.
Elas estão no arquivo 'src/mockFunctions.js'.
Crie mock functions para cada uma das operações de modo que os cálculos sejam
feitos corretamente,
...
describe('3 - Verifica as funções e os mocks', () => {
  ...
  test('testa função add', () => {
    mockFunctions.add = jest
      ...
      .mockReturnValueOnce(8 + 37)
      .mockReturnValueOnce(-11 + 25)
      .mockReturnValueOnce(13 - 188)
      .mockReturnValueOnce(7 + 26);
  ...
  test('testa função subtract', () => {
    mockFunctions.subtract = jest
      .fn()
      .mockReturnValueOnce(899 - 35)
      .mockReturnValueOnce(-17 - 333)
      .mockReturnValueOnce(45 - 97)
      .mockReturnValueOnce(23 + 108)
      .mockReturnValueOnce(-133 + 29);
  ...
  test('testa função multiply', () => {
    mockFunctions.multiply = jest
      ...
      .mockReturnValueOnce(-12 * (-7))
      .mockReturnValueOnce(19 * 23);
  ...
  test('testa função divide', () => {
    mockFunctions.divide = jest
      .fn()
      .mockReturnValueOnce(169 / 13)
      .mockReturnValueOnce(-1900 / 5)
      .mockReturnValueOnce(42 / 7)
      .mockReturnValueOnce(729 / 243)
      .mockReturnValueOnce(1331 / 11);
  ...
  test('testa função factorial', () => {
    mockFunctions.factorial = jest
      .fn()
      .mockReturnValueOnce(rFact(5))
      .mockReturnValueOnce(rFact(10))
      .mockReturnValueOnce(rFact(3))
      .mockReturnValueOnce(rFact(8))
      .mockReturnValueOnce(rFact(2));
