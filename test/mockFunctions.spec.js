...
describe('3 - Verifica as funções e os mocks', () => {
  ...
  test('testa função factorial', () => {
    ...
    // meu erro era ter colocado o fact como 0, pois sempre daria zero, ante e elém disso, o fact estava incrementando += i e não *= i.... Pois eu achei que era em adição.
