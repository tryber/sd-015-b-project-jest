...
- Gênero: Masculino ok
- Primeiro nome: Antônio ok
- Último nome: Britto ok
- País: Brasil ok
- Email: tunico@bol.com.br (Sim, é um email do bol mesmo...) ok
- Nome de usuário: tunicao123 ok
- Senha: 1234567890 (Usem senhas fortes, crianças!) ok
...
describe('2 - Verifica o usuário', () => {
  ...
  api.fetchURL.mockResolvedValue(forcedResult);
